...
data22 = data %>% filter(Age == '22-25') %>% select(-rawid,-Age,-Gender) %>% scale
data26 = data %>% filter(Age == '26-30') %>% select(-rawid,-Age,-Gender) %>% scale
data31 = data %>% filter(Age == '31-35') %>% select(-rawid,-Age,-Gender) %>% scale
# hist(data22 %>% unlist)
...
for(rho in seq(1e-50,1e-1,length.out = 500)){
